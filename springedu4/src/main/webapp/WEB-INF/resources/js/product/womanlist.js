...
event.preventDefault(); //기본이벤트 막기
 ...
 if(strArray.length>8){
	...
	const url = `/portfolio/product/womanlist/1/${order}/${lcategory}/${searchTypeTag.value}/${keywordTag.value}`;
	console.log(url);
	...
	function recommnadlist_f(event){
		...
		const url = `/portfolio/product/recommandlist/1`;
		window.location.href = url; 
	}
	//관심상품
		...
		const url = `/portfolio/product/basketlist/1/1`;
		window.location.href = url; 
	}	
	...
	function newlist_f(event){
		...
		const url = `/portfolio/product/womanlist/1/1/${lcategory}/${searchTypevalue}/${keywordTagvalue}`;
 ...
 if(strArray.length>8){
	...
	const url = `/portfolio/product/womanlist/1/4/${lcategory}/${searchTypevalue}/${keywordTagvalue}`;
	console.log(url);
	window.location.href = url; 	
	}
 ...
 if(strArray.length>8){
	...
	const url = `/portfolio/product/womanlist/1/5/${lcategory}/${searchTypevalue}/${keywordTagvalue}`;
	console.log(url);
	window.location.href = url; 	
	}
 ...
 function listCategorys_f(event) {
  console.log("카테고리 선택함.");
	...
	const url = `/portfolio/product/womanlist/1/${category.value}/`;
	console.log(url);
	//window.location.href = url; 	
} 
