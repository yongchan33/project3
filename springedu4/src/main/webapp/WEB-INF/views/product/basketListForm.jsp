...
<script defer src="${contextPath }/js/product/basketlist.js"></script>
</head>
<body>
	<!-- 최상위메뉴 -->
 ...
 <%@ include file="/WEB-INF/views/product/sidebar.jsp" %>
	...
	<!-- 이미지 출력 -->
	 <div class="cbox"> 
	  ...
	  <c:forEach var="rec" items="${requestScope.basketlist }">
		<div class = "box"> 	
	 ...
	 <!-- 페이지  -->
	  <div class="paging">
	        <c:if test="${findCriteria.pageCriteria.prev}">
		        <div>
		        	<a href="${contextPath }/product/basketlist/1"><i class="fas fa-angle-double-left"></i></a>
		        </div>
		        <div>
		        	<a href="${contextPath }/product/basketlist/${findCriteria.pageCriteria.startPage-1}"><i class="fas fa-angle-left"></i></a>
		        </div>
	        	</c:if>
		...
		<c:forEach var="pageNum"
					...
					<div>
						...
						<a href="${contextPath }/product/basketlist/${pageNum }">${pageNum }</a>
					</div>
		        ...
		        <div>
		        	<a href="${contextPath }/product/basketlist/${findCriteria.pageCriteria.endPage+1}"><i class="fas fa-angle-right"></i></a>
		        </div>
		        <div>
		        	<a href="${contextPath }/product/basketlist/${findCriteria.pageCriteria.finalEndPage}"><i class="fas fa-angle-double-right"></i></a>
		        </div>
		        </c:if>
		        </div>
		        </div>
