...
<script defer src="${contextPath }/js/product/womanlist.js"></script>
</head>
<body>
	<!-- 최상위메뉴 -->
...
<!-- side bar -->
 <%@ include file="/WEB-INF/views/product/sidebar.jsp" %>
	...
	<div class="bodyline">
	<div class="headline">
				<div class="mtitle">여성의류</div>
				<div class="clist-w">

					<ul>
						<li><a name="listCategory" value="11"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/11/${findCriteria.searchType}/${findCriteria.keyword}">아우터</a></li>
						<li><a name="listCategory" value="12"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/12/${findCriteria.searchType}/${findCriteria.keyword}">반팔/긴팔/민소매</a></li>
						<li><a name="listCategory" value="13"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/13/${findCriteria.searchType}/${findCriteria.keyword}">원피스</a></li>
						<li><a name="listCategory" value="14"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/14/${findCriteria.searchType}/${findCriteria.keyword}">블라우스/셔츠</a></li>
						<li><a name="listCategory" value="15"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/15/${findCriteria.searchType}/${findCriteria.keyword}">니트/가디건</a></li>
						<li><a name="listCategory" value="16"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/16/${findCriteria.searchType}/${findCriteria.keyword}">후드/맨투맨</a></li>
						<li><a name="listCategory" value="17"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/17/${findCriteria.searchType}/${findCriteria.keyword}">팬츠</a></li>
						<li><a name="listCategory" value="18"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/18/${findCriteria.searchType}/${findCriteria.keyword}">스커트</a></li>
						<li><a name="listCategory" value="19"
							href="${contextPath }/product/womanlist/${requestScope.reqPagecategory }/${requestScope.reqmlist }/19/${findCriteria.searchType}/${findCriteria.keyword}">수트</a></li>
		...
		<div class="cprice"><fmt:formatNumber value="${rec.p_sale_price }" pattern="###,###,###" />원</div>
			...
			<div class="paging">
				<c:if test="${findCriteria.pageCriteria.prev}">
					<div>
						<a	href="${contextPath }/product/womanlist/1/${requestScope.reqmlist }/${requestScope.listCategory }/${findCriteria.searchType}/${findCriteria.keyword}"><i
							class="fas fa-angle-double-left"></i></a>
					</div>
					<div>
						<a	href="${contextPath }/product/womanlist/${findCriteria.pageCriteria.startPage-1}/${requestScope.reqmlist }/${requestScope.listCategory }/${findCriteria.searchType}/${findCriteria.keyword}"><i
							class="fas fa-angle-left"></i></a>
					</div>
				</c:if>

				<c:forEach var="pageNum"
					begin="${findCriteria.pageCriteria.startPage }"	end="${findCriteria.pageCriteria.endPage }">
					<!-- 현재페이지와 요청페이지가 같으면 -->
					...
					<a href="${contextPath }/product/womanlist/${pageNum }/${requestScope.reqmlist }/${requestScope.listCategory }/${findCriteria.searchType}/${findCriteria.keyword}">${pageNum }</a>
			</div>

			</c:forEach>
			<c:if test="${findCriteria.pageCriteria.next}">
				<div>
					<a	href="${contextPath }/product/womanlist/${findCriteria.pageCriteria.endPage+1}/${requestScope.reqmlist }/${requestScope.listCategory }/${findCriteria.searchType}/${findCriteria.keyword}">
					<i class="fas fa-angle-right"></i></a>
				</div>
				<div>
					<a	href="${contextPath }/product/womanlist/${findCriteria.pageCriteria.finalEndPage}/${requestScope.reqmlist }/${requestScope.listCategory }/${findCriteria.searchType}/${findCriteria.keyword}">
