...
public class MemberDAOImplJdbc {
	...
	public int joinMember(MemberVO memberVO) {
		...
		result = jdbcTemplate.update(sql.toString(), memberVO.getId(), memberVO.getPw(), memberVO.getTel(),
				memberVO.getName(), memberVO.getGender(), memberVO.getAddress(), memberVO.getBirth());
...
//		logger.info("MemberDAOImpl.modifyMember(MemberVO memberVO) 호출됨");
		...
		result = jdbcTemplate.update(sql.toString(), memberVO.getTel(), memberVO.getName(), memberVO.getGender(),
				memberVO.getAddress(), memberVO.getBirth(), memberVO.getId(), memberVO.getPw());
